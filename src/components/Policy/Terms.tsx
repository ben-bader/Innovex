    ...
    >
      ...
      >
        ...
        <div className="text-start -mt-12 mb-8">
          ...
          <h1 className="lg:text-6xl text-4xl font-semibold mb-4"><span className="font-squid text-transparent bg-clip-text bg-gradient-to-tr from-purple-400 to-blue-500">Terms</span> & Conditions</h1>
          <p className="text-gray-300 max-w-2xl">
            These Terms govern your use of Innovex&apos;s website and services. By accessing or
            using our services, you accept these Terms. Last updated: {updatedAt}.
          </p>
        ...
        <article className="bg-gray-900/50 border border-white/10 rounded-2xl p-8 text-gray-200 space-y-6">
          <section>
            ...
            <p className="text-sm">
              You agree to use the service only for lawful purposes. You must not misuse the
              services or interfere with them.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm">
              All content on the site, including design, text, logos, and images, is owned
              by Innovex or its licensors. You may not reproduce or distribute content
              without permission.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-2">5. Disclaimers & Limitation</h2>
            <p className="text-sm">
              Services are provided &quot;as is.&quot; Innovex is not liable for indirect damages. Our
              total liability is limited to the fees paid by you in the last 12 months.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm">
              These Terms are governed by the laws of the jurisdiction in which Innovex is
              located. Disputes will be resolved in local courts unless otherwise agreed.
            </p>
          </section>
