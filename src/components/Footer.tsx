...
const Footer = () => {
  return (
    <footer className="flex flex-col overflow-hidden gap-32 max-sm:gap-20 py-16 px-20 max-sm:px-10 relative">
      ...
      <div className="flex max-sm:flex-col max-sm:gap-8 justify-between">
        <div className="flex flex-col items-start gap-4">
            <Logo/>
            <p className="text-gray-200">Your altimate tech events <br /> exploring platform.</p>
        </div>
        <div>
            <h1 className="text-xl mb-2">Menu</h1>
            <ul>
                <li className="text-gray-400"><a href="/main#home">Home</a></li>
                <li className="text-gray-400"><a href="/main#about">About</a></li>
                <li className="text-gray-400"><a href="/main#contact">Contact</a></li>
            </ul>
        </div>
        <div>
            <h1 className="text-xl mb-2">Explore</h1>
            <ul>
                <li className="text-gray-400"><a href="/main#events">Events</a></li>
                <li className="text-gray-400"><a href="/main#categories">Categories</a></li>
                <li className="text-gray-400"><a href="">Blog</a></li>
            </ul>
        </div>
        <div>
            <h1 className="text-xl mb-2">Community</h1>
            <p className="text-gray-400">Connect with other <br /> events attendees.</p>
        </div>
      </div>
      <div className="flex max-sm:flex-col gap-8 justify-between">
        <div className="flex gap-6">
            <a href="/main/policy/terms" target="_blank">Terms</a>
            <a href="/main/policy/privacy" target="_blank">Privacy</a>
            <a href="/main/policy/cookies" target="_blank">Cookies</a>
        </div>
        <div className="max-sm:order-last">
            &copy;
            2025 By Bader. All Right Reserved.
        </div>
